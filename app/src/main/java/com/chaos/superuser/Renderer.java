...
import com.chaos.superuser.common.RawResourceReader;
import com.chaos.superuser.common.ShaderHelper;
import com.chaos.superuser.common.ShapeBuilder;
import com.chaos.superuser.common.TextureHelper;
...
public class Renderer implements GLSurfaceView.Renderer {
    ...
    private final float[] mLightPosInModelSpace = new float[] {0.0f, 0.75f, 0.75f, 1.0f};
     ...
     */
    public Renderer(final MainActivity mainActivity, final GLSurfaceView glSurfaceView) {
                ...
                mGlSurfaceView.queueEvent(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            mUseVBOs = useVbos;
                            mMainActivity.updateVboStatus(mUseVBOs);

                            mUseStride = useStride;
                            mMainActivity.updateStrideStatus(mUseStride);
...
//						Toast.makeText(mLessonSevenActivity, "Out of memory; Dalvik takes a while to clean up the memory. Please try again.\nExternal bytes allocated=" + dalvik.system.VMRuntime.getRuntime().getExternalBytesAllocated(), Toast.LENGTH_LONG).show();
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config)
    {
        ...
        final String vertexShader = RawResourceReader.readTextFileFromRawResource(mMainActivity, R.raw.lesson_seven_vertex_shader);
        final String fragmentShader = RawResourceReader.readTextFileFromRawResource(mMainActivity, R.raw.lesson_seven_fragment_shader);
        ...
        // Load the texture
        mAndroidDataHandle = TextureHelper.loadTexture(mMainActivity, R.drawable.prism_512);
    ...
    public void onDrawFrame(GL10 glUnused)
    {
        ...
        Matrix.translateM(mLightModelMatrix, 0, 0.0f, -1.0f, -1.0f);
        ...
        Matrix.translateM(mModelMatrix,0, 0.0f,0.0f,mDeltaZ);
        mDeltaX = 0.0f;
        mDeltaY = 0.0f;
